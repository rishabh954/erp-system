...
urlpatterns = [
    ...
    path('api/v1/', include([
        ...
        path('inventory/', include('apps.inventory.api.urls', namespace='api_inventory')),
        path('accounting/', include('apps.accounting.api.urls', namespace='api_accounting')),
        ...
        path('documents/', include('apps.documents.api.urls', namespace='api_documents')),
        path('notifications/', include('apps.notifications.api.urls', namespace='api_notifications')),
        path('workflow/', include('apps.workflow.api.urls', namespace='api_workflow')),
        path('dashboard/', include('apps.dashboard.api.urls', namespace='api_dashboard')),
