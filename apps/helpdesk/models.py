...
class TicketCategory(CompanyScoped):
    ...
    auto_assign_to = models.ForeignKey('authentication.User', null=True, blank=True, on_delete=models.SET_NULL)
...
class Ticket(CompanyScoped, SequenceMixin, NotesMixin):
    ...
    requester = models.ForeignKey('authentication.User', on_delete=models.PROTECT, related_name='submitted_tickets')
    ...
    source = models.CharField(max_length=15, choices=Source.choices, default=Source.PORTAL)
