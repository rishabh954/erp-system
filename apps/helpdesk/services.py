...
class TicketService(BaseService):
    ...
    def create_ticket(self, data, user):
        ...
        ticket.number = BaseService.generate_sequence_number('TKT', Ticket, self.company.pk)
        ticket.save()
    ...
    def add_comment(self, ticket, user, content, is_internal=False):
        ...
        if not ticket.first_response_at and not is_internal and user != ticket.requester:
