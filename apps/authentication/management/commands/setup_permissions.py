...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        modules = ['sales', 'crm', 'accounting', 'inventory', 'projects', 'hrms', 'company', 'purchase']
        ...
        matrix = {
            ...
            User.Role.EMPLOYEE: {
                'hrms': (False, True, False, False, False, False, False), # Can read own data, logic in views
                'projects': (False, True, True, False, False, False, False), # Can update assigned tasks
                'company': (False, True, False, False, False, False, False),
            },
            User.Role.CUSTOMER_PORTAL: {
                'sales': (False, True, False, False, False, False, False), # Read own invoices
                'projects': (False, True, False, False, False, False, False), # Read own projects
            }
        }
        ...
        for role_choice in User.Role.choices:
            ...
            for module in modules:
                ...
                if role in [User.Role.SUPER_ADMIN, User.Role.COMPANY_ADMIN]:
                    ...
                    perms = role_matrix.get(module, (False, False, False, False, False, False, False))
                    c, r, u, d, a, e, i = perms
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully set up permissions! Created: {created_count}, Updated: {updated_count}.'))
