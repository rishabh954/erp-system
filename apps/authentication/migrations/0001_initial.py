    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('login', 'Login'), ('logout', 'Logout'), ('password_change', 'Password Change'), ('password_reset', 'Password Reset'), ('profile_update', 'Profile Update'), ('create', 'Create'), ('update', 'Update'), ('delete', 'Delete'), ('view', 'View'), ('export', 'Export'), ('import', 'Import'), ('approve', 'Approve'), ('reject', 'Reject'), ('failed_login', 'Failed Login')], db_index=True, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role_override', models.CharField(blank=True, choices=[('super_admin', 'Super Admin'), ('company_admin', 'Company Admin'), ('hr_manager', 'HR Manager'), ('finance_manager', 'Finance Manager'), ('sales_manager', 'Sales Manager'), ('purchase_manager', 'Purchase Manager'), ('inventory_manager', 'Inventory Manager'), ('project_manager', 'Project Manager'), ('employee', 'Employee'), ('customer_portal', 'Customer Portal User')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('super_admin', 'Super Admin'), ('company_admin', 'Company Admin'), ('hr_manager', 'HR Manager'), ('finance_manager', 'Finance Manager'), ('sales_manager', 'Sales Manager'), ('purchase_manager', 'Purchase Manager'), ('inventory_manager', 'Inventory Manager'), ('project_manager', 'Project Manager'), ('employee', 'Employee'), ('customer_portal', 'Customer Portal User')], db_index=True, default='employee', max_length=30)),
                ('is_active', models.BooleanField(default=True)),
                ...
                ('two_factor_method', models.CharField(choices=[('totp', 'Authenticator App'), ('email', 'Email'), ('sms', 'SMS')], default='totp', max_length=10)),
