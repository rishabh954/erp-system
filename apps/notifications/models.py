...
class NotificationPreference(CompanyScoped):
    user = models.ForeignKey('authentication.User', on_delete=models.CASCADE, related_name='notification_preferences')
    notification_type = models.CharField(max_length=15, choices=Notification.NotificationType.choices)
