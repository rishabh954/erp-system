    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "module",
                    models.CharField(
                        help_text="e.g. sales, hrms, accounting", max_length=50
                    ),
                ),
                (
                    "base_model",
                    models.CharField(
                        help_text="e.g. apps.sales.models.Invoice", max_length=100
                    ),
                ),
                (
                    "columns",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data_source",
                    models.CharField(
                        help_text="API endpoint or query name", max_length=200
                    ),
                ),
                (
                    "config",
                ...
                (
                    "height",
                    models.PositiveSmallIntegerField(default=4, help_text="Grid rows"),
                ),
                (
                    "refresh_interval",
                    models.PositiveIntegerField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="administration.customdashboard",
                    ),
                ),
                (
                    "deleted_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "css_content",
                    models.TextField(
                        blank=True, help_text="Custom CSS for print styling"
                    ),
                ),
                ("is_default", models.BooleanField(default=False)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider",
                    models.CharField(
                        help_text="e.g. Razorpay, Shopify, Shiprocket", max_length=100
                    ),
                ),
                (
                    "credentials",
                    models.JSONField(
                        default=dict, help_text="Encrypted credentials JSON"
                    ),
                ),
                (
                    "settings",
                    models.JSONField(
                        default=dict, help_text="Provider-specific settings"
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Email subject (supports {{variables}})",
                        max_length=500,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_url",
                    models.URLField(blank=True, help_text="For custom HTTP provider"),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("is_default", models.BooleanField(default=False)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "secret",
                    models.CharField(
                        blank=True, help_text="HMAC signing secret", max_length=200
                    ),
                ),
                (
                    "events",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "waba_id",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="WABA ID"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        ...
                        name="admin_audit_user_id_f87675_idx",
                    ),
                ],
            },
        ),
