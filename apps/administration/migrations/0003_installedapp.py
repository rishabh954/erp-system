    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_label', models.CharField(choices=[('accounting', 'Accounting'), ('crm', 'CRM'), ('sales', 'Sales'), ('purchase', 'Purchase'), ('inventory', 'Inventory'), ('manufacturing', 'Manufacturing'), ('hrms', 'HR & Payroll'), ('projects', 'Projects'), ('helpdesk', 'Helpdesk'), ('assets', 'Assets'), ('pos', 'Point of Sale'), ('documents', 'Documents'), ('portals', 'Customer & Vendor Portals'), ('analytics', 'Reporting & Analytics'), ('workflow', 'Workflows')], max_length=50)),
