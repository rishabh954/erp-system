...
from apps.administration.models import APIKey, BackupSchedule
...
class APIKeyManagementView(LoginRequiredMixin, AdminRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if name:
            ...
            messages.success(
                request,
                f"API Key '{name}' generated successfully. Please copy it now as it won't be visible again: {new_key.key}",
            )
