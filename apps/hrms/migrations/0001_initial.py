    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "attachment",
                    models.FileField(blank=True, null=True, upload_to="leaves/"),
                ),
                (
                    "approved_by",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "leave_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="hrms.leavetype"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="hrms.salarystructure"
            ),
        ),
        migrations.CreateModel(
            name="WorkSchedule",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["company", "date"],
                        name="hrms_attend_company_062029_idx",
                    ),
                    models.Index(
                        fields=["employee", "date"],
                        name="hrms_attend_employe_a6dc5c_idx",
                    ),
                ],
        ...
        migrations.AddIndex(
            model_name="employee",
            index=models.Index(
                fields=["company", "status"], name="hrms_employ_company_f4ff70_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="employee",
            index=models.Index(
                fields=["company", "joining_date"],
                name="hrms_employ_company_39338b_idx",
            ),
        ),
