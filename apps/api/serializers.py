...
class ErpProductSerializer(serializers.ModelSerializer):
    ...
    tracking_display = serializers.CharField(source='get_tracking_method_display', read_only=True)
...
class LeaveRequestSerializer(serializers.ModelSerializer):
    ...
    def get_employee_name(self, obj):
        return f"{obj.employee.first_name} {obj.employee.last_name}".strip() if obj.employee else None
