...
from .views import (
    CreateDeliveryFromSOView,
    CreateInvoiceFromSOView,
    CreditNoteDetailView,
    CreditNoteListView,
    InvoiceCreateView,
    InvoiceDeleteView,
    InvoiceDetailView,
    InvoiceGeneratePaymentLinkView,
    InvoiceListView,
    InvoicePDFView,
    InvoiceUpdateView,
    PaymentListView,
    ...
    SubscriptionGenerateInvoiceView,
...
urlpatterns = [
    ...
    path(
        "quotations/<uuid:pk>/edit/",
        QuotationUpdateView.as_view(),
        name="quotation_update",
    ),
    path(
        "quotations/<uuid:pk>/delete/",
    ...
    path(
        "subscriptions/<uuid:pk>/edit/",
        SubscriptionUpdateView.as_view(),
        name="subscription_update",
    ),
    path(
        "subscriptions/<uuid:pk>/invoice/",
        SubscriptionGenerateInvoiceView.as_view(),
    ...
    path(
        "commissions/<uuid:pk>/pay/",
        SalesCommissionPayView.as_view(),
        name="commission_pay",
    ),
    ...
    path(
        "orders/<uuid:pk>/delete/", SalesOrderDeleteView.as_view(), name="order_delete"
    ),
    path(
        "orders/<uuid:pk>/cancel/", SalesOrderCancelView.as_view(), name="order_cancel"
    ),
    path(
    ...
    path(
        "orders/<uuid:pk>/delivery/",
        CreateDeliveryFromSOView.as_view(),
        name="order_delivery",
    ),
    ...
    path(
        "invoices/<uuid:pk>/payment-link/",
        InvoiceGeneratePaymentLinkView.as_view(),
        name="invoice_payment_link",
    ),
    path(
        "invoices/<uuid:pk>/edit/", InvoiceUpdateView.as_view(), name="invoice_update"
    ),
    path(
        "invoices/<uuid:pk>/delete/", InvoiceDeleteView.as_view(), name="invoice_delete"
    ),
