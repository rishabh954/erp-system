...
class QuotationService(BaseService):
    ...
    def create_quotation(self, data, user):
        ...
        quot.number = BaseService.generate_sequence_number('QUO', Quotation, self.company.pk)
        quot.save()
...
class SalesOrderService(BaseService):
    ...
    def create_order(self, data, user):
        ...
        order.number = BaseService.generate_sequence_number('SO', SalesOrder, self.company.pk)
        order.save()
...
class InvoiceService(BaseService):
    ...
    def create_invoice(self, data):
        ...
        invoice.number = BaseService.generate_sequence_number('INV', Invoice, self.company.pk)
        invoice.save()
...
class SalesOrderService(BaseService):
    ...
    def create_delivery(self, order):
        ...
        if not warehouse:
            raise ValueError('No active warehouse found. Please create a warehouse first.')
    ...
    def create_invoice(self, order):
        ...
        inv.number = BaseService.generate_sequence_number('INV', Invoice, order.company_id)
        inv.save()
