...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('A', 'A-Class'), ('B', 'B-Class'), ('C', 'C-Class')], help_text='A: Top 80%, B: Next 15%, C: Bottom 5% value', max_length=1, null=True),
        ),
        migrations.AddField(
            model_name='product',
            name='needs_qa',
            field=models.BooleanField(default=False, help_text='Requires Quality Inspection on receipt'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('in_progress', 'In Progress'), ('counted', 'Counted / Pending Review'), ('completed', 'Completed / Adjusted'), ('cancelled', 'Cancelled')], default='draft', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_quantity', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('number', models.CharField(blank=True, db_index=True, max_length=50, unique=True)),
                ('status', models.CharField(choices=[('pending', 'Pending Inspection'), ('passed', 'Passed'), ('failed', 'Failed'), ('partial', 'Partially Passed')], default='pending', max_length=20)),
                ('inspection_date', models.DateTimeField(blank=True, null=True)),
                ('quantity_inspected', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('quantity_passed', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('quantity_failed', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='company.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_deleted', to=settings.AUTH_USER_MODEL)),
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.product')),
                ('receipt', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inspections', to='purchase.goodsreceipt')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_updated', to=settings.AUTH_USER_MODEL)),
            ],
            options={
