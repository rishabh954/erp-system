    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('requested', 'Requested'), ('approved', 'Approved'), ('in_transit', 'In Transit'), ('received', 'Received'), ('cancelled', 'Cancelled')], default='draft', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('stockable', 'Stockable Product'), ('consumable', 'Consumable'), ('service', 'Service'), ('digital', 'Digital')], default='stockable', max_length=15)),
                ...
                ('min_sale_price', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('tracking_method', models.CharField(choices=[('none', 'No Tracking'), ('lot', 'By Lot/Batch'), ('serial', 'By Serial Number')], default='none', max_length=10)),
                ('min_stock_level', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('max_stock_level', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('reorder_point', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('reorder_quantity', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ...
                ('cogs_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cogs_products', to='accounting.account')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='company.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='company.currency')),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_deleted', to=settings.AUTH_USER_MODEL)),
                ('inventory_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='inventory_products', to='accounting.account')),
                ('revenue_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='revenue_products', to='accounting.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_sent', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uom_type', models.CharField(choices=[('unit', 'Unit'), ('weight', 'Weight'), ('volume', 'Volume'), ('length', 'Length'), ('area', 'Area'), ('time', 'Time')], default='unit', max_length=20)),
                ('is_active', models.BooleanField(default=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='company.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_deleted', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='product',
            name='purchase_uom',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='purchase_products', to='inventory.unitofmeasure'),
        ),
        migrations.AddField(
            model_name='product',
            name='uom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_incoming', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ...
                ('bin_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='inventory.binlocation')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='company.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_deleted', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('number', models.CharField(blank=True, db_index=True, max_length=50, unique=True)),
                ('movement_type', models.CharField(choices=[('receipt', 'Receipt (Purchase)'), ('delivery', 'Delivery (Sale)'), ('transfer', 'Warehouse Transfer'), ('adjustment', 'Stock Adjustment'), ('return_in', 'Return In'), ('return_out', 'Return Out'), ('production_in', 'Production In'), ('production_out', 'Production Out'), ('opening', 'Opening Stock')], db_index=True, max_length=20)),
                ...
                ('stock_after', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ('bin_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='inventory.binlocation')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_set', to='company.company')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_deleted', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['company', 'is_active'], name='inventory_p_company_fd7b98_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['company', 'category'], name='inventory_p_company_acf921_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['product', 'warehouse', 'movement_date'], name='inventory_s_product_0880c6_idx'),
        ),
        migrations.AddIndex(
            model_name='stockmovement',
            index=models.Index(fields=['company', 'movement_type', 'movement_date'], name='inventory_s_company_2ed6ce_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='binlocation',
