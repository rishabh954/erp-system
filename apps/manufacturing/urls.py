...
urlpatterns = [
    ...
    path(
        "work-orders/<uuid:pk>/start/",
        views.WorkOrderStartView.as_view(),
        name="work_order_start",
    ),
    path(
        "work-orders/<uuid:pk>/complete/",
    ...
    path(
        "scrap/",
        __import__(
            "apps.manufacturing.views", fromlist=["ScrapOrderListView"]
        ).ScrapOrderListView.as_view(),
        name="scrap_orders",
    ),
    path(
        "scrap/<uuid:pk>/",
        __import__(
            "apps.manufacturing.views", fromlist=["ScrapOrderDetailView"]
        ).ScrapOrderDetailView.as_view(),
        name="scrap_order_detail",
    ),
    path(
        "downtime/",
        __import__(
            "apps.manufacturing.views", fromlist=["DowntimeLogListView"]
        ).DowntimeLogListView.as_view(),
        name="downtime_logs",
    ),
    path(
        "downtime/<uuid:pk>/",
        __import__(
            "apps.manufacturing.views", fromlist=["DowntimeLogDetailView"]
        ).DowntimeLogDetailView.as_view(),
        name="downtime_log_detail",
    ),
    # Quality Control & Costing
    path(
        "quality/",
        __import__(
            "apps.manufacturing.views", fromlist=["QualityCheckListView"]
        ).QualityCheckListView.as_view(),
        name="quality_checks",
    ),
    path(
        "quality/<uuid:pk>/",
        __import__(
            "apps.manufacturing.views", fromlist=["QualityCheckDetailView"]
        ).QualityCheckDetailView.as_view(),
        name="quality_check_detail",
    ),
    path(
        "costing/",
        __import__(
            "apps.manufacturing.views", fromlist=["ProductionCostingListView"]
        ).ProductionCostingListView.as_view(),
        name="production_costings",
    ),
    path(
        "costing/<uuid:pk>/",
        __import__(
            "apps.manufacturing.views", fromlist=["ProductionCostingDetailView"]
        ).ProductionCostingDetailView.as_view(),
        name="production_costing_detail",
    ),
