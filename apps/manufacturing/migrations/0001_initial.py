            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=4,
                        default=1,
                        help_text="Quantity of finished product this BOM produces",
                        max_digits=15,
                    ),
                ),
                ...
                (
                    "product",
                    models.ForeignKey(
                        help_text="The finished product",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="boms",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "component",
                    models.ForeignKey(
                        help_text="Raw material or subassembly",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Where finished goods will be stored and raw materials consumed",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0,
                        help_text="Operating cost per hour for landed cost calculation",
                        max_digits=15,
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        default=1, help_text="Number of simultaneous operations"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="manufacturing.routingoperation",
                    ),
                ),
                (
                    "updated_by",
