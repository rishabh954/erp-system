...
from .api.views import ContractViewSet, CustomerViewSet, LeadViewSet
from .views import (
    AddActivityView,
    CampaignCreateView,
    CampaignDetailView,
...
from .views_setup import (
    LeadAssignmentRuleCreateView,
    LeadAssignmentRuleDeleteView,
    LeadAssignmentRuleListView,
    LeadAssignmentRuleUpdateView,
    SalesTargetCreateView,
    SalesTargetDeleteView,
    SalesTargetListView,
    SalesTargetUpdateView,
    TerritoryCreateView,
    TerritoryDeleteView,
    TerritoryListView,
    TerritoryUpdateView,
...
urlpatterns = [
    ...
    path(
        "leads/<uuid:pk>/status/",
        LeadUpdateStatusView.as_view(),
        name="lead_update_status",
    ),
    path("leads/<uuid:pk>/convert/", LeadConvertView.as_view(), name="lead_convert"),
    path(
        "leads/<uuid:pk>/toggle-opportunity/",
        LeadToggleOpportunityView.as_view(),
        name="lead_toggle_opportunity",
    ),
    path(
        "leads/<uuid:pk>/activity/", AddActivityView.as_view(), name="lead_add_activity"
    ),
    ...
    path(
        "setup/territories/create/",
        TerritoryCreateView.as_view(),
        name="territory_create",
    ),
    path(
        "setup/territories/<uuid:pk>/edit/",
        TerritoryUpdateView.as_view(),
        name="territory_update",
    ),
    path(
        "setup/territories/<uuid:pk>/delete/",
        TerritoryDeleteView.as_view(),
        name="territory_delete",
    ),
    path("setup/rules/", LeadAssignmentRuleListView.as_view(), name="rule_list"),
    path(
        "setup/rules/create/",
        LeadAssignmentRuleCreateView.as_view(),
        name="rule_create",
    ),
    path(
        "setup/rules/<uuid:pk>/edit/",
        LeadAssignmentRuleUpdateView.as_view(),
        name="rule_update",
    ),
    path(
        "setup/rules/<uuid:pk>/delete/",
        LeadAssignmentRuleDeleteView.as_view(),
        name="rule_delete",
    ),
    path("setup/targets/", SalesTargetListView.as_view(), name="target_list"),
    path(
        "setup/targets/create/", SalesTargetCreateView.as_view(), name="target_create"
    ),
    path(
        "setup/targets/<uuid:pk>/edit/",
        SalesTargetUpdateView.as_view(),
        name="target_update",
    ),
    path(
        "setup/targets/<uuid:pk>/delete/",
        SalesTargetDeleteView.as_view(),
        name="target_delete",
    ),
]
