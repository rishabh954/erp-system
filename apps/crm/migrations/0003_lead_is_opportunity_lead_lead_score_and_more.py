...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='lead',
            name='is_opportunity',
            field=models.BooleanField(default=False, help_text='If True, this is considered a qualified deal/opportunity.'),
        ),
        migrations.AddField(
            model_name='lead',
            name='lead_score',
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(blank=True, help_text='Duration in minutes for calls/meetings', null=True),
        ),
        migrations.AddField(
            model_name='leadactivity',
