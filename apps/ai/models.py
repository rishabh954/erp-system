...
class AIConfiguration(CompanyScoped):
    ...
    ai_provider          = models.CharField(max_length=20, default='openai',
                              choices=[('openai','OpenAI'), ('gemini','Google Gemini'), ('disabled','Disabled')])
...
class OCRDocument(CompanyScoped):
    ...
    doc_type      = models.CharField(max_length=10, choices=DocType.choices, default=DocType.INVOICE)
...
class NLPReport(CompanyScoped):
    ...
    generated_query = models.TextField(blank=True, help_text='The ORM/SQL generated from the NL query')
