...
from .views import (  # Chat; NLP Reports; Forecasting; OCR; Insights; Purchase; Expense; Financial Summary; Dashboard Assistant; Settings
    AIHubView,
    AISettingsView,
    CategoriseExpensesView,
    ChatDeleteConversationView,
    ChatNewConversationView,
    ChatSendMessageView,
    ChatView,
    CustomerInsightsView,
    DashboardAssistantView,
    ExpenseCategorisationView,
    FinancialSummaryView,
    ForecastDataView,
    ForecastView,
    GenerateCustomerInsightsView,
    GenerateFinancialSummaryView,
    GeneratePurchaseRecommendationsView,
    NLPReportQueryView,
    NLPReportView,
    OCRResultView,
    OCRStatusView,
    OCRUploadView,
    PurchaseRecommendationView,
)
...
urlpatterns = [
    ...
    path(
        "chat/<uuid:conv_id>/delete/",
        ChatDeleteConversationView.as_view(),
        name="chat_delete",
    ),
    # NLP Reports
    ...
    path(
        "insights/generate/",
        GenerateCustomerInsightsView.as_view(),
        name="insights_generate",
    ),
    # Purchase Recommendations
    path(
        "purchase-recommendations/",
        PurchaseRecommendationView.as_view(),
        name="purchase_recommendations",
    ),
    path(
        "purchase-recommendations/generate/",
        GeneratePurchaseRecommendationsView.as_view(),
        name="purchase_recommendations_generate",
    ),
    # Expense Categorisation
    path(
        "expense-categorisation/",
        ExpenseCategorisationView.as_view(),
        name="expense_categorisation",
    ),
    path(
        "expense-categorisation/process/",
        CategoriseExpensesView.as_view(),
        name="categorise_expenses",
    ),
    # Financial Summary
    path(
        "financial-summary/", FinancialSummaryView.as_view(), name="financial_summary"
    ),
    path(
        "financial-summary/generate/",
        GenerateFinancialSummaryView.as_view(),
        name="financial_summary_generate",
    ),
