    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_provider', models.CharField(choices=[('openai', 'OpenAI'), ('gemini', 'Google Gemini'), ('disabled', 'Disabled')], default='openai', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', models.CharField(default='general', help_text='Module context: general, sales, finance, hr, inventory…', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('forecast_type', models.CharField(choices=[('sales', 'Sales Forecast'), ('inventory', 'Inventory Forecast'), ('demand', 'Demand Prediction'), ('revenue', 'Revenue Forecast')], max_length=15)),
                ('period', models.CharField(default='30d', help_text='7d, 30d, 90d, 6m, 1y', max_length=20)),
                ('scope_model', models.CharField(blank=True, max_length=100)),
                ('scope_id', models.CharField(blank=True, max_length=100)),
                ('forecast_data', models.JSONField(default=dict, help_text='{"labels":[],"predicted":[],"lower_bound":[],"upper_bound":[],"metrics":{}}')),
                ('algorithm', models.CharField(default='linear_regression', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('insight_type', models.CharField(choices=[('customer', 'Customer Insight'), ('financial', 'Financial Summary'), ('purchase', 'Purchase Recommendation'), ('expense', 'Expense Analysis'), ('dashboard', 'Dashboard Summary'), ('sales_trend', 'Sales Trend')], max_length=20)),
                ('title', models.CharField(max_length=255)),
                ('narrative', models.TextField()),
                ('data_snapshot', models.JSONField(default=dict)),
                ('scope_id', models.CharField(blank=True, help_text='Customer ID, product ID, etc. if scoped', max_length=100)),
                ('generated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('doc_type', models.CharField(choices=[('invoice', 'Invoice'), ('receipt', 'Receipt'), ('other', 'Other')], default='invoice', max_length=10)),
                ...
                ('extracted_data', models.JSONField(default=dict, help_text='{"vendor":"","date":"","total":"","tax":"","currency":"","line_items":[]}')),
                ('raw_text', models.TextField(blank=True)),
                ('confidence', models.FloatField(blank=True, help_text='Overall confidence score 0.0–1.0', null=True)),
