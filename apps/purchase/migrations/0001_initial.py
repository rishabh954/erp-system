    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('sent', 'Sent to Vendor'), ('confirmed', 'Confirmed'), ('partial', 'Partially Received'), ('received', 'Fully Received'), ('invoiced', 'Invoiced'), ('cancelled', 'Cancelled')], db_index=True, default='draft', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('completed', 'Completed'), ('cancelled', 'Cancelled')], default='draft', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qty_invoiced', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_accepted', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
                ...
                ('po_line', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='purchase.purchaseorderline')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('submitted', 'Submitted'), ('approved', 'Approved'), ('rejected', 'Rejected'), ('ordered', 'Purchase Order Created'), ('cancelled', 'Cancelled')], db_index=True, default='draft', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=500)),
                ('quantity', models.DecimalField(decimal_places=4, max_digits=15)),
                ('estimated_unit_price', models.DecimalField(decimal_places=4, default=0, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_code', models.CharField(blank=True, db_index=True, max_length=50)),
                ('vendor_type', models.CharField(choices=[('supplier', 'Supplier'), ('contractor', 'Contractor'), ('service', 'Service Provider')], default='supplier', max_length=20)),
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('blocked', 'Blocked'), ('pending', 'Pending Approval')], db_index=True, default='active', max_length=15)),
