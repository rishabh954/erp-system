...
from .portal_views import (
    VendorPortalBidCreateView,
    VendorPortalDashboardView,
    VendorPortalRFQDetailView,
    VendorPortalRFQListView,
)
from .views import (
...
urlpatterns = [
    ...
    path(
        "vendors/<uuid:pk>/evaluate/",
        VendorEvaluateView.as_view(),
        name="vendor_evaluate",
    ),
    # Requests
    ...
    path(
        "requests/<uuid:pk>/update/",
        PurchaseRequestUpdateView.as_view(),
        name="request_update",
    ),
    path(
        "requests/<uuid:pk>/delete/",
    ...
    path(
        ...
        GoodsReceiptCreateView.as_view(),
        name="order_receive",
    ),
    # Bills & Payments
    path(
        "pos/<uuid:pk>/create-bill/",
        CreateBillFromPOView.as_view(),
        name="po_create_bill",
    ),
    ...
    path(
        "bills/<uuid:pk>/record-payment/",
        RecordVendorPaymentView.as_view(),
        name="bill_record_payment",
    ),
    # Receipts
    path("receipts/", GoodsReceiptListView.as_view(), name="receipts"),
    path(
        "receipts/<uuid:pk>/", GoodsReceiptDetailView.as_view(), name="receipt_detail"
    ),
    path(
        "receipts/<uuid:pk>/update/",
        GoodsReceiptUpdateView.as_view(),
        name="receipt_update",
    ),
    path(
        "receipts/<uuid:pk>/delete/",
        GoodsReceiptDeleteView.as_view(),
        name="receipt_delete",
    ),
    ...
    path(
        "portal/rfqs/<uuid:pk>/",
        VendorPortalRFQDetailView.as_view(),
        name="portal_rfq_detail",
    ),
    path(
        "portal/rfqs/<uuid:rfq_pk>/bid/",
        VendorPortalBidCreateView.as_view(),
        name="portal_bid_create",
    ),
]
