...
urlpatterns = [
    ...
    path('customer/payments/', views.CustomerPaymentListView.as_view(), name='customer_payments'),
    ...
    path('customer/documents/', views.CustomerDocumentListView.as_view(), name='customer_documents'),
    path('customer/contracts/', views.CustomerContractListView.as_view(), name='customer_contracts'),
    path('customer/shipments/', views.CustomerShipmentListView.as_view(), name='customer_shipments'),
    path('customer/shipments/<uuid:pk>/', views.CustomerShipmentDetailView.as_view(), name='customer_shipment_detail'),
    ...
    path('vendor/orders/<uuid:pk>/', views.VendorOrderDetailView.as_view(), name='vendor_order_detail'),
    path('vendor/bills/', views.VendorBillListView.as_view(), name='vendor_bills'),
    path('vendor/payments/', views.VendorPaymentListView.as_view(), name='vendor_payments'),
