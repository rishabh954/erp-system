...
urlpatterns = [
    ...
    path(
        "reports/bulk-delete/", views.ReportBulkDeleteView.as_view(), name="bulk_delete"
    ),
    ...
    path(
        "reports/<uuid:pk>/data/", views.ReportDataAPIView.as_view(), name="report_data"
    ),
    # Module fields
    ...
    path(
        "api/generate/",
        views.GenerateReportAPIView.as_view(),
        name="api_generate_report",
    ),
    path(
        "api/fields/legacy/",
        views.GetModuleFieldsAPIView.as_view(),
        name="api_get_fields",
    ),
]
