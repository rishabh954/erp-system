...
from .views import (
    ChartOfAccountsView, AccountDetailView, AccountCreateView,
    JournalListView, JournalEntryCreateView, JournalEntryDetailView, PostJournalEntryView,
    BankAccountListView, FinancialReportsView,
    BalanceSheetView, ProfitAndLossView, TrialBalanceView,
    GeneralLedgerView, ARAgingReportView, APAgingReportView,
    CostCenterListView, CostCenterDetailView, CostCenterCreateView,
    BudgetListView, BudgetDetailView, BudgetCreateView,
    AccountingDashboardView, BankReconciliationView
)
from .statement_views import BankStatementListView, BankStatementCreateView
...
urlpatterns = [
    ...
    path('bank/statements/', BankStatementListView.as_view(), name='bank_statement_list'),
    path('bank/statements/import/', BankStatementCreateView.as_view(), name='bank_statement_import'),
    path('bank/reconciliation/', BankReconciliationView.as_view(), name='bank_reconciliation'),
    ...
    path('cost-centers/<uuid:pk>/', CostCenterDetailView.as_view(), name='cost_center_detail'),
    ...
    path('credit-note/issue/', __import__('apps.accounting.views', fromlist=['IssueCreditNoteView']).IssueCreditNoteView.as_view(), name='issue_credit_note'),
]
