...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "company_id", type=str, help="UUID of the company to seed COA for"
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.NOTICE(
                f"Seeding default Chart of Accounts for {company.name}..."
            )
        )
        ...
        chart = [
            ...
            {
                "code": "3010",
                "name": "Owner's / Shareholder's Equity",
                "type": "equity",
                "subtype": "capital",
            },
            {
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully created {created_count} default accounts for {company.name}."
            )
        )
